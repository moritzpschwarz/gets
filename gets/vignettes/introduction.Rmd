...
caption = "\\label{table:comparison-of-gets-algorithms}", 
...
<!-- Variable selection properties of GETS algorithms. The -->
<!-- table is essentially Table 2 in -->
<!-- \citet[][p.~724]{sucarrat2012automated} augmented by the -->
...
<!-- are from \citet[][Table 4 on p.~179]{hoover1999data}. The -->
<!-- properties of the \pkg{PcGets} algorithm are from -->
<!-- \citet[][Figure 1 on p.~C39]{hendry2005properties}, and the -->
...
# Hoover and Perez [@hoover1999data] simulations
